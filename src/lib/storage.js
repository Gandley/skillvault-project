...
import { skills as defaultSkills, categories as defaultCategories, skillPacks as defaultSkillPacks, individualSkills as defaultIndividualSkills } from '../data/skills.js';

const STORAGE_KEY = 'skillvault_data_v9';
...
export function loadData() {
  ...
  return { skills: defaultSkills, categories: defaultCategories, skillPacks: defaultSkillPacks, individualSkills: defaultIndividualSkills };
}
